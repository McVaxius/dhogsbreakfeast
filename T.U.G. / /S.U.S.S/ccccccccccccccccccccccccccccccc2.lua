...
valid_pvp_escape = {
	...
	[1294] = {187.177, -2.000, 99.600,  11.792, -2.000, 100.139}  --- the bayside battleground (wuk lamat tits)
}
...
--we are our own enemy (var init)
enemy1 = GetCharacterName(false)
enemy2 = enemy1
enemy3 = enemy1
enemy4 = enemy1
enemy5 = enemy1
